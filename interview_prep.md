...
**2:15–3:15 — methods.** “I compare raw and temperature-scaled ECE/NLL/Brier, a five-model ensemble and MC dropout, APS coverage/set size, risk–coverage and failure-detection AUROC, energy and Mahalanobis shift scores, and quantitative Grad-CAM stability. The operational research question is selective review or triage: rank uncertain images and ask whether reviewing a bounded fraction recovers lower risk. This is not a validated clinical policy.”
...
A singleton may permit the normal workflow; a multi-class or atypically large set could trigger image re-acquisition or human review. The action threshold and cost must be prospectively defined, and marginal 90% coverage is not a per-patient safety guarantee.
